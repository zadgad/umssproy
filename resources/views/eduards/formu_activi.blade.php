       ...
       <div  class="row">
           <div class="col-md-8">
               ...
               <div class="card-block">
                       ...
                       <div class="form">
                           <form method="post" action="{{route('insert_act')}}" autocomplete="off" class="cmxform form-horizontal style-form" id="signupForm" method="get" action=""
                           ...
                           >
                             ...
                             <div class="form-group row">
                               ...
                               <div id="unidad" class="form-group row" >
                                <label class="col-sm-3 col-form-label">{{ __('Nombre de Sub-Proyecto') }}</label>
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="subp" id="input-name" type="text" placeholder="{{ __('Nombre de Sub-Proyecto') }}" value="{{ old('subp') }}" required="true" aria-required="true" list="unid"/>
                                      <datalist id="unid" >
                                          @foreach($subp as $sub)
                                          <option value="{{$sub->codigo}}" > {{$sub->nombr_subp}} </option>
                                          @endforeach
                                    </datalist>
                                    </div>
                                  </div>
                               ...
                               <div id="unidad" class="form-group row" >
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="codigo" id="input-name" type="text" placeholder="{{ __('Unidad de Medida') }}" value="{{ old('codigo') }}" required="true" aria-required="true" list="select"/>
                                      <datalist id="select" >
                               ...
                               <div  class="form-group row" ">
                                   ...
                                   <div class="col-sm-9">
                                     <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                         <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="cant" id="input-name" type="text" placeholder="{{ __('0.00 ') }}" value="{{ old('cant') }}" required="true" aria-required="true"/>
                                         @if ($errors->has('name'))
                                           <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                         @endif
                                     </div>
                             ...
                             <div class="form-group">
                               <div class="col-lg-offset-2 col-lg-10">
                                 <button class="btn btn-theme" type="submit">Registrar Actividad</button>
                               </div>
                             </div>
                           </form>
                         </div>
