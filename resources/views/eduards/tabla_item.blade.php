            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Lista de los Items en el Sistem</h5>
                            <span>Informacion de los ITEMS registrados en sistema</span>
                            <br>
                            <br>
                            <h6> </h6>
                        </div>
                ...
                <div class="dt-responsive">
                    <table id="lang-dt"
                        ...
                        <tbody>
                         ...
                         <td class="text-center">
                            <a href="{{ route('preciost',$ad=$sel->codigo_it) }}"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
