 ...
 <div class="main-content">
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Editar la Informacion del Proyecto</h5>
                            <span>Editar la informacion necesaria para el sistema</span>
                            <br>
                            <br>
                            <h6> </h6>
                        </div>
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Editar la Informacion</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div  class="row">
            <div class="col-md-8">
                <div class="card">
                <div class="card-header"><h3>Formulario De Edicion Del Proyecto</h3></div>
                ...
                <div class="card-block">
                        ...
                        <div class="form">
                            <form method="post" action="{{route('valpro')}}" autocomplete="off" class="cmxform form-horizontal style-form" id="signupForm" method="get" action=""
                            ...
                            >
                                ...
                                <div  class="form-group row" style="display:none;" >
                                    ...
                                    <div class="col-sm-9">
                                      <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                          <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="proy" id="input-name" type="text" placeholder="{{ __('Nombre ') }}" value="{{ old('proy',$val[0]->id_proye) }}" required="true" aria-required="true"/>
                                          @if ($errors->has('name'))
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="proyect" id="input-name" type="text" placeholder="{{ __('Nombre de Proyecto') }}" value="{{ old('proyect',$val[0]->nombr_proy) }}" required="true" aria-required="true" />
                                      @if ($errors->has('name'))
                                      <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                    @endif
                                    </div>
  ...
  --}}                                          <select id="list_vial" class="form-control" name="clasifi" >
                                        <option value="{{ $val[0]->tipo }}">Seleccionar Clasificacion</option>
  ...
  --}}                                          <select id="provi" class="form-control" name="provin"  >
                                        <option value="{{ $val[0]->provincia }}">Seleccionar Provincia</option>
                              ...
                              <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                  <button class="btn btn-theme" type="submit">Editar Proyecto</button>
                                </div>
                              </div>
                            </form>
                          </div>
