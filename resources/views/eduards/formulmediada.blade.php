        ...
        <div  class="row">
            <div class="col-md-8">
                ...
                <div class="card-block">
                        ...
                        <div class="form">
                            <form method="post" action="{{route('inunid')}}" autocomplete="off" class="cmxform form-horizontal style-form" id="signupForm" method="get" action=""
                            ...
                            >
                              ...
                              <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                  <button class="btn btn-theme" type="submit">Añadir Unidad</button>
                                </div>
                              </div>
                            </form>
                          </div>
