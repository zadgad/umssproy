                        ...
                        <tbody>
                         ...
                         <td class="text-center">
                             ...
                             <td class="text-center">
                              ...
                              <td class="text-center">
                                <a  href="{{route('formu_edit',$id=$dato->codigo_mt)}}"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
                                <a href="{{ route('boact',$ad=$dato->codigo_mt) }}"><i class="ik ik-trash-2 f-16 text-red"></i></a>
